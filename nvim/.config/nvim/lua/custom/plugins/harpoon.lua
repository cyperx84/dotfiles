return {
  ...
  config = function()
    ...
    vim.keymap.set("n", "<C-M-j>", function() ui.nav_file(5) end, {
      desc = "Harpoon File 5",
    })
    vim.keymap.set("n", "<C-M-k>", function() ui.nav_file(6) end, {
      desc = "Harpoon File 6",
    })
    vim.keymap.set("n", "<C-M-l>", function() ui.nav_file(7) end, {
      desc = "Harpoon File 7",
    })
    vim.keymap.set("n", "<C-M-h>", function() ui.nav_file(7) end, {
      desc = "Harpoon File 7",
    })
  end,
}
