...
requires-python\:"Optimize for selecting latest supported version of each package, for each supported Python version"))' '*-C+[Settings to pass to the PEP 517 build backend, specified as \`KEY=VALUE\` pairs]:CONFIG_SETTING:_default' '*--config-setting=[Settings to pass to the PEP 517 build backend, specified as \`KEY=VALUE\` pairs]:CONFIG_SETTING:_default' '*--no-build-isolation-package=[Disable isolation when building source distributions for a specific package]:NO_BUILD_ISOLATION_PACKAGE:_default' '--exclude-newer=[Limit candidate packages to those that were uploaded prior to the given date]:EXCLUDE_NEWER:_default' '--link-mode=[The method to use when installing packages from the global cache]:LINK_MODE:((clone\:"Clone (i.e., copy-on-write) packages from the wheel into the \`site-packages\` directory"
...
none\:"Do not use any version control system"))' '(--script --no-package)--build-backend=[Initialize a build-backend of choice for the project]:BUILD_BACKEND:((hatch\:"Use \[hatchling\](https\://pypi.org/project/hatchling) as the project build backend"
...
never\:"Do not ever allow Python downloads"))' '(--no-color)--color=[Control the use of color in output]:COLOR_CHOICE:((auto\:"Enables colored output only when the output is going to a terminal or TTY with support"
always\:"Enables colored output regardless of the detected environment"
never\:"Disables colored output"))' '*--allow-insecure-host=[Allow insecure connections to a host]:ALLOW_INSECURE_HOST:_default' '--directory=[Change to the given directory prior to running the command]:DIRECTORY:_files' '--project=[Run the command within the given project directory]:PROJECT:_files' '--config-file=[The path to a \`uv.toml\` file to use for configuration]:CONFIG_FILE:_files' '--isolated[Run the tool in an isolated virtual environment, ignoring any already-installed tools]' '--no-env-file[Avoid reading environment variables from a \`.env\` file]' '--no-index[Ignore the registry index (e.g., PyPI), instead relying on direct URL dependencies and those provided via \`--find-links\`]' '-U[Allow package upgrades, ignoring pinned versions in any existing output file. Implies \`--refresh\`]' '--upgrade[Allow package upgrades, ignoring pinned versions in any existing output file. Implies \`--refresh\`]' '--no-upgrade[]' '--reinstall[Reinstall all packages, regardless of whether they'\''re already installed. Implies \`--refresh\`]' '--no-reinstall[]' '--pre[]' '--no-build-isolation[Disable isolation when building source distributions]' '--build-isolation[]' '--compile-bytecode[Compile Python files to bytecode after installation]' '--no-compile-bytecode[]' '--no-sources[Ignore the \`tool.uv.sources\` table when resolving dependencies. Used to lock against the standards-compliant, publishable package metadata, as opposed to using any workspace, Git, URL, or local path sources]' '--no-build[Don'\''t build source distributions]' '--build[]' '--no-binary[Don'\''t install pre-built wheels]' '--binary[]' '(--offline)--refresh[Refresh all cached data]' '(--offline)--no-refresh[]' '--show-resolution[Whether to show resolver and installer output from any environment modifications]' '-n[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '--no-cache[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '(--python-preference)--managed-python[Require use of uv-managed Python versions]' '(--python-preference)--no-managed-python[Disable use of uv-managed Python versions]' '--allow-python-downloads[Allow automatically downloading Python when required. \[env\: "UV_PYTHON_DOWNLOADS=auto"\]]' '--no-python-downloads[Disable automatic downloads of Python. \[env\: "UV_PYTHON_DOWNLOADS=never"\]]' '(-v --verbose)*-q[Use quiet output]' '(-v --verbose)*--quiet[Use quiet output]' '(-q --quiet)*-v[Use verbose output]' '(-q --quiet)*--verbose[Use verbose output]' '(--color)--no-color[Disable colors]' '--native-tls[Whether to load TLS certificates from the platform'\''s native certificate store]' '--no-native-tls[]' '--offline[Disable network access]' '--no-offline[]' '--preview[Whether to enable experimental, preview features]' '--no-preview[]' '--show-settings[Show the resolved settings for the current command]' '--no-progress[Hide all progress outputs]' '--no-installer-metadata[Skip writing \`uv\` installer metadata files (e.g., \`INSTALLER\`, \`REQUESTED\`, and \`direct_url.json\`) to site-packages \`.dist-info\` directories]' '--no-config[Avoid discovering configuration files (\`pyproject.toml\`, \`uv.toml\`)]' '-h[Display the concise help for this command]' '--help[Display the concise help for this command]' && ret=0  ;;
...
never\:"Disables colored output"))' '*--allow-insecure-host=[Allow insecure connections to a host]:ALLOW_INSECURE_HOST:_default' '--directory=[Change to the given directory prior to running the command]:DIRECTORY:_files' '--project=[Run the command within the given project directory]:PROJECT:_files' '--config-file=[The path to a \`uv.toml\` file to use for configuration]:CONFIG_FILE:_files' '--isolated[Run the tool in an isolated virtual environment, ignoring any already-installed tools]' '--no-env-file[Avoid reading environment variables from a \`.env\` file]' '--no-index[Ignore the registry index (e.g., PyPI), instead relying on direct URL dependencies and those provided via \`--find-links\`]' '-U[Allow package upgrades, ignoring pinned versions in any existing output file. Implies \`--refresh\`]' '--upgrade[Allow package upgrades, ignoring pinned versions in any existing output file. Implies \`--refresh\`]' '--no-upgrade[]' '--reinstall[Reinstall all packages, regardless of whether they'\''re already installed. Implies \`--refresh\`]' '--no-reinstall[]' '--pre[]' '--no-build-isolation[Disable isolation when building source distributions]' '--build-isolation[]' '--compile-bytecode[Compile Python files to bytecode after installation]' '--no-compile-bytecode[]' '--no-sources[Ignore the \`tool.uv.sources\` table when resolving dependencies. Used to lock against the standards-compliant, publishable package metadata, as opposed to using any workspace, Git, URL, or local path sources]' '--no-build[Don'\''t build source distributions]' '--build[]' '--no-binary[Don'\''t install pre-built wheels]' '--binary[]' '(--offline)--refresh[Refresh all cached data]' '(--offline)--no-refresh[]' '--show-resolution[Whether to show resolver and installer output from any environment modifications]' '-V[Display the uvx version]' '--version[Display the uvx version]' '-n[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '--no-cache[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '(--python-preference)--managed-python[Require use of uv-managed Python versions]' '(--python-preference)--no-managed-python[Disable use of uv-managed Python versions]' '--allow-python-downloads[Allow automatically downloading Python when required. \[env\: "UV_PYTHON_DOWNLOADS=auto"\]]' '--no-python-downloads[Disable automatic downloads of Python. \[env\: "UV_PYTHON_DOWNLOADS=never"\]]' '(-v --verbose)*-q[Use quiet output]' '(-v --verbose)*--quiet[Use quiet output]' '(-q --quiet)*-v[Use verbose output]' '(-q --quiet)*--verbose[Use verbose output]' '(--color)--no-color[Disable colors]' '--native-tls[Whether to load TLS certificates from the platform'\''s native certificate store]' '--no-native-tls[]' '--offline[Disable network access]' '--no-offline[]' '--preview[Whether to enable experimental, preview features]' '--no-preview[]' '--show-settings[Show the resolved settings for the current command]' '--no-progress[Hide all progress outputs]' '--no-installer-metadata[Skip writing \`uv\` installer metadata files (e.g., \`INSTALLER\`, \`REQUESTED\`, and \`direct_url.json\`) to site-packages \`.dist-info\` directories]' '--no-config[Avoid discovering configuration files (\`pyproject.toml\`, \`uv.toml\`)]' '-h[Display the concise help for this command]' '--help[Display the concise help for this command]' && ret=0  ;;
								(install) _arguments "${_arguments_options[@]}" : '--from=[The package to install commands from]:FROM:_default' '*-w+[Include the following additional requirements]:WITH:_default' '*--with=[Include the following additional requirements]:WITH:_default' '*--with-requirements=[Include all requirements listed in the given \`requirements.txt\` files]:WITH_REQUIREMENTS:_default' '*--with-editable=[Include the given packages in editable mode]:WITH_EDITABLE:_default' '*-c+[Constrain versions using the given requirements files]:CONSTRAINTS:_default' '*--constraints=[Constrain versions using the given requirements files]:CONSTRAINTS:_default' '*--overrides=[Override versions using the given requirements files]:OVERRIDES:_default' '*-b+[Constrain build dependencies using the given requirements files when building source distributions]:BUILD_CONSTRAINTS:_default' '*--build-constraints=[Constrain build dependencies using the given requirements files when building source distributions]:BUILD_CONSTRAINTS:_default' '*--index=[The URLs to use when resolving dependencies, in addition to the default index]:INDEX:_default' '--default-index=[The URL of the default package index (by default\: <https\://pypi.org/simple>)]:DEFAULT_INDEX:_default' '-i+[(Deprecated\: use \`--default-index\` instead) The URL of the Python package index (by default\: <https\://pypi.org/simple>)]:INDEX_URL:_default' '--index-url=[(Deprecated\: use \`--default-index\` instead) The URL of the Python package index (by default\: <https\://pypi.org/simple>)]:INDEX_URL:_default' '*--extra-index-url=[(Deprecated\: use \`--index\` instead) Extra URLs of package indexes to use, in addition to \`--index-url\`]:EXTRA_INDEX_URL:_default' '*-f+[Locations to search for candidate distributions, in addition to those found in the registry indexes]:FIND_LINKS:_default' '*--find-links=[Locations to search for candidate distributions, in addition to those found in the registry indexes]:FIND_LINKS:_default' '*-P+[Allow upgrades for a specific package, ignoring pinned versions in any existing output file. Implies \`--refresh-package\`]:UPGRADE_PACKAGE:_default' '*--upgrade-package=[Allow upgrades for a specific package, ignoring pinned versions in any existing output file. Implies \`--refresh-package\`]:UPGRADE_PACKAGE:_default' '*--reinstall-package=[Reinstall a specific package, regardless of whether it'\''s already installed. Implies \`--refresh-package\`]:REINSTALL_PACKAGE:_default' '--index-strategy=[The strategy to use when resolving against multiple index URLs]:INDEX_STRATEGY:((first-index\:"Only use results from the first index that returns a match for a given package name"
unsafe-first-match\:"Search for every package name across all indexes, exhausting the versions from the first index before moving on to the next"
unsafe-best-match\:"Search for every package name across all indexes, preferring the "best" version found. If a package version is in multiple indexes, only look at the entry for the first index"))' '--keyring-provider=[Attempt to use \`keyring\` for authentication for index URLs]:KEYRING_PROVIDER:((disabled\:"Do not use keyring for credential lookup"
subprocess\:"Use the \`keyring\` command for credential lookup"))' '--resolution=[The strategy to use when selecting between the different compatible versions for a given package requirement]:RESOLUTION:((highest\:"Resolve the highest compatible version of each package"
lowest\:"Resolve the lowest compatible version of each package"
...
never\:"Do not ever allow Python downloads"))' '(--no-color)--color=[Control the use of color in output]:COLOR_CHOICE:((auto\:"Enables colored output only when the output is going to a terminal or TTY with support"
always\:"Enables colored output regardless of the detected environment"
never\:"Disables colored output"))' '*--allow-insecure-host=[Allow insecure connections to a host]:ALLOW_INSECURE_HOST:_default' '--directory=[Change to the given directory prior to running the command]:DIRECTORY:_files' '--project=[Run the command within the given project directory]:PROJECT:_files' '--config-file=[The path to a \`uv.toml\` file to use for configuration]:CONFIG_FILE:_files' '--show-paths[Whether to display the path to each tool environment and installed executable]' '--show-version-specifiers[Whether to display the version specifier(s) used to install each tool]' '--show-with[Whether to display the additional requirements installed with each tool]' '--show-extras[Whether to display the extra requirements installed with each tool]' '--no-python-downloads[]' '-n[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '--no-cache[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '(--python-preference)--managed-python[Require use of uv-managed Python versions]' '(--python-preference)--no-managed-python[Disable use of uv-managed Python versions]' '--allow-python-downloads[Allow automatically downloading Python when required. \[env\: "UV_PYTHON_DOWNLOADS=auto"\]]' '(-v --verbose)*-q[Use quiet output]' '(-v --verbose)*--quiet[Use quiet output]' '(-q --quiet)*-v[Use verbose output]' '(-q --quiet)*--verbose[Use verbose output]' '(--color)--no-color[Disable colors]' '--native-tls[Whether to load TLS certificates from the platform'\''s native certificate store]' '--no-native-tls[]' '--offline[Disable network access]' '--no-offline[]' '--preview[Whether to enable experimental, preview features]' '--no-preview[]' '--isolated[Avoid discovering a \`pyproject.toml\` or \`uv.toml\` file]' '--show-settings[Show the resolved settings for the current command]' '--no-progress[Hide all progress outputs]' '--no-installer-metadata[Skip writing \`uv\` installer metadata files (e.g., \`INSTALLER\`, \`REQUESTED\`, and \`direct_url.json\`) to site-packages \`.dist-info\` directories]' '--no-config[Avoid discovering configuration files (\`pyproject.toml\`, \`uv.toml\`)]' '-h[Display the concise help for this command]' '--help[Display the concise help for this command]' && ret=0  ;;
...
never\:"Do not ever allow Python downloads"))' '(--no-color)--color=[Control the use of color in output]:COLOR_CHOICE:((auto\:"Enables colored output only when the output is going to a terminal or TTY with support"
always\:"Enables colored output regardless of the detected environment"
never\:"Disables colored output"))' '*--allow-insecure-host=[Allow insecure connections to a host]:ALLOW_INSECURE_HOST:_default' '--directory=[Change to the given directory prior to running the command]:DIRECTORY:_files' '--project=[Run the command within the given project directory]:PROJECT:_files' '--config-file=[The path to a \`uv.toml\` file to use for configuration]:CONFIG_FILE:_files' '--bin[Show the directory into which \`uv tool\` will install executables.]' '-n[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '--no-cache[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '(--python-preference)--managed-python[Require use of uv-managed Python versions]' '(--python-preference)--no-managed-python[Disable use of uv-managed Python versions]' '--allow-python-downloads[Allow automatically downloading Python when required. \[env\: "UV_PYTHON_DOWNLOADS=auto"\]]' '--no-python-downloads[Disable automatic downloads of Python. \[env\: "UV_PYTHON_DOWNLOADS=never"\]]' '(-v --verbose)*-q[Use quiet output]' '(-v --verbose)*--quiet[Use quiet output]' '(-q --quiet)*-v[Use verbose output]' '(-q --quiet)*--verbose[Use verbose output]' '(--color)--no-color[Disable colors]' '--native-tls[Whether to load TLS certificates from the platform'\''s native certificate store]' '--no-native-tls[]' '--offline[Disable network access]' '--no-offline[]' '--preview[Whether to enable experimental, preview features]' '--no-preview[]' '--isolated[Avoid discovering a \`pyproject.toml\` or \`uv.toml\` file]' '--show-settings[Show the resolved settings for the current command]' '--no-progress[Hide all progress outputs]' '--no-installer-metadata[Skip writing \`uv\` installer metadata files (e.g., \`INSTALLER\`, \`REQUESTED\`, and \`direct_url.json\`) to site-packages \`.dist-info\` directories]' '--no-config[Avoid discovering configuration files (\`pyproject.toml\`, \`uv.toml\`)]' '-h[Display the concise help for this command]' '--help[Display the concise help for this command]' && ret=0  ;;
							esac ;;
					esac ;;
...
never\:"Do not ever allow Python downloads"))' '(--no-color)--color=[Control the use of color in output]:COLOR_CHOICE:((auto\:"Enables colored output only when the output is going to a terminal or TTY with support"
always\:"Enables colored output regardless of the detected environment"
never\:"Disables colored output"))' '*--allow-insecure-host=[Allow insecure connections to a host]:ALLOW_INSECURE_HOST:_default' '--directory=[Change to the given directory prior to running the command]:DIRECTORY:_files' '--project=[Run the command within the given project directory]:PROJECT:_files' '--config-file=[The path to a \`uv.toml\` file to use for configuration]:CONFIG_FILE:_files' '-r[Reinstall the requested Python version, if it'\''s already installed]' '--reinstall[Reinstall the requested Python version, if it'\''s already installed]' '-f[Replace existing Python executables during installation]' '--force[Replace existing Python executables during installation]' '--default[Use as the default Python version]' '-n[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '--no-cache[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '(--python-preference)--managed-python[Require use of uv-managed Python versions]' '(--python-preference)--no-managed-python[Disable use of uv-managed Python versions]' '--allow-python-downloads[Allow automatically downloading Python when required. \[env\: "UV_PYTHON_DOWNLOADS=auto"\]]' '--no-python-downloads[Disable automatic downloads of Python. \[env\: "UV_PYTHON_DOWNLOADS=never"\]]' '(-v --verbose)*-q[Use quiet output]' '(-v --verbose)*--quiet[Use quiet output]' '(-q --quiet)*-v[Use verbose output]' '(-q --quiet)*--verbose[Use verbose output]' '(--color)--no-color[Disable colors]' '--native-tls[Whether to load TLS certificates from the platform'\''s native certificate store]' '--no-native-tls[]' '--offline[Disable network access]' '--no-offline[]' '--preview[Whether to enable experimental, preview features]' '--no-preview[]' '--isolated[Avoid discovering a \`pyproject.toml\` or \`uv.toml\` file]' '--show-settings[Show the resolved settings for the current command]' '--no-progress[Hide all progress outputs]' '--no-installer-metadata[Skip writing \`uv\` installer metadata files (e.g., \`INSTALLER\`, \`REQUESTED\`, and \`direct_url.json\`) to site-packages \`.dist-info\` directories]' '--no-config[Avoid discovering configuration files (\`pyproject.toml\`, \`uv.toml\`)]' '-h[Display the concise help for this command]' '--help[Display the concise help for this command]' '*::targets -- The Python version(s) to install:_default' && ret=0  ;;
...
never\:"Do not ever allow Python downloads"))' '(--no-color)--color=[Control the use of color in output]:COLOR_CHOICE:((auto\:"Enables colored output only when the output is going to a terminal or TTY with support"
always\:"Enables colored output regardless of the detected environment"
never\:"Disables colored output"))' '*--allow-insecure-host=[Allow insecure connections to a host]:ALLOW_INSECURE_HOST:_default' '--directory=[Change to the given directory prior to running the command]:DIRECTORY:_files' '--project=[Run the command within the given project directory]:PROJECT:_files' '--config-file=[The path to a \`uv.toml\` file to use for configuration]:CONFIG_FILE:_files' '--no-project[Avoid discovering a project or workspace]' '--system[Only find system Python interpreters]' '--no-system[]' '--show-version[Show the Python version that would be used instead of the path to the interpreter]' '-n[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '--no-cache[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '(--python-preference)--managed-python[Require use of uv-managed Python versions]' '(--python-preference)--no-managed-python[Disable use of uv-managed Python versions]' '--allow-python-downloads[Allow automatically downloading Python when required. \[env\: "UV_PYTHON_DOWNLOADS=auto"\]]' '--no-python-downloads[Disable automatic downloads of Python. \[env\: "UV_PYTHON_DOWNLOADS=never"\]]' '(-v --verbose)*-q[Use quiet output]' '(-v --verbose)*--quiet[Use quiet output]' '(-q --quiet)*-v[Use verbose output]' '(-q --quiet)*--verbose[Use verbose output]' '(--color)--no-color[Disable colors]' '--native-tls[Whether to load TLS certificates from the platform'\''s native certificate store]' '--no-native-tls[]' '--offline[Disable network access]' '--no-offline[]' '--preview[Whether to enable experimental, preview features]' '--no-preview[]' '--isolated[Avoid discovering a \`pyproject.toml\` or \`uv.toml\` file]' '--show-settings[Show the resolved settings for the current command]' '--no-progress[Hide all progress outputs]' '--no-installer-metadata[Skip writing \`uv\` installer metadata files (e.g., \`INSTALLER\`, \`REQUESTED\`, and \`direct_url.json\`) to site-packages \`.dist-info\` directories]' '--no-config[Avoid discovering configuration files (\`pyproject.toml\`, \`uv.toml\`)]' '-h[Display the concise help for this command]' '--help[Display the concise help for this command]' '::request -- The Python request:_default' && ret=0  ;;
...
never\:"Do not ever allow Python downloads"))' '(--no-color)--color=[Control the use of color in output]:COLOR_CHOICE:((auto\:"Enables colored output only when the output is going to a terminal or TTY with support"
always\:"Enables colored output regardless of the detected environment"
never\:"Disables colored output"))' '*--allow-insecure-host=[Allow insecure connections to a host]:ALLOW_INSECURE_HOST:_default' '--directory=[Change to the given directory prior to running the command]:DIRECTORY:_files' '--project=[Run the command within the given project directory]:PROJECT:_files' '--config-file=[The path to a \`uv.toml\` file to use for configuration]:CONFIG_FILE:_files' '--bin[Show the directory into which \`uv python\` will install Python executables.]' '-n[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '--no-cache[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '(--python-preference)--managed-python[Require use of uv-managed Python versions]' '(--python-preference)--no-managed-python[Disable use of uv-managed Python versions]' '--allow-python-downloads[Allow automatically downloading Python when required. \[env\: "UV_PYTHON_DOWNLOADS=auto"\]]' '--no-python-downloads[Disable automatic downloads of Python. \[env\: "UV_PYTHON_DOWNLOADS=never"\]]' '(-v --verbose)*-q[Use quiet output]' '(-v --verbose)*--quiet[Use quiet output]' '(-q --quiet)*-v[Use verbose output]' '(-q --quiet)*--verbose[Use verbose output]' '(--color)--no-color[Disable colors]' '--native-tls[Whether to load TLS certificates from the platform'\''s native certificate store]' '--no-native-tls[]' '--offline[Disable network access]' '--no-offline[]' '--preview[Whether to enable experimental, preview features]' '--no-preview[]' '--isolated[Avoid discovering a \`pyproject.toml\` or \`uv.toml\` file]' '--show-settings[Show the resolved settings for the current command]' '--no-progress[Hide all progress outputs]' '--no-installer-metadata[Skip writing \`uv\` installer metadata files (e.g., \`INSTALLER\`, \`REQUESTED\`, and \`direct_url.json\`) to site-packages \`.dist-info\` directories]' '--no-config[Avoid discovering configuration files (\`pyproject.toml\`, \`uv.toml\`)]' '-h[Display the concise help for this command]' '--help[Display the concise help for this command]' && ret=0  ;;
...
copy\:"Copy packages from the wheel into the \`site-packages\` directory"
hardlink\:"Hard link packages from the wheel into the \`site-packages\` directory"
symlink\:"Symbolically link packages from the wheel into the \`site-packages\` directory"))' '*--refresh-package=[Refresh cached data for a specific package]:REFRESH_PACKAGE:_default' '*--group=[Install the specified dependency group from a \`pyproject.toml\`]:GROUP:_default' '-o+[Write the compiled requirements to the given \`requirements.txt\` or \`pylock.toml\` file]:OUTPUT_FILE:_files' '--output-file=[Write the compiled requirements to the given \`requirements.txt\` or \`pylock.toml\` file]:OUTPUT_FILE:_files' '--format=[The format in which the resolution should be output]:FORMAT:((requirements.txt\:"Export in \`requirements.txt\` format"
...
unsafe-first-match\:"Search for every package name across all indexes, exhausting the versions from the first index before moving on to the next"
unsafe-best-match\:"Search for every package name across all indexes, preferring the "best" version found. If a package version is in multiple indexes, only look at the entry for the first index"))' '--keyring-provider=[Attempt to use \`keyring\` for authentication for index URLs]:KEYRING_PROVIDER:((disabled\:"Do not use keyring for credential lookup"
subprocess\:"Use the \`keyring\` command for credential lookup"))' '*-C+[Settings to pass to the PEP 517 build backend, specified as \`KEY=VALUE\` pairs]:CONFIG_SETTING:_default' '*--config-setting=[Settings to pass to the PEP 517 build backend, specified as \`KEY=VALUE\` pairs]:CONFIG_SETTING:_default' '--exclude-newer=[Limit candidate packages to those that were uploaded prior to the given date]:EXCLUDE_NEWER:_default' '--link-mode=[The method to use when installing packages from the global cache]:LINK_MODE:((clone\:"Clone (i.e., copy-on-write) packages from the wheel into the \`site-packages\` directory"
copy\:"Copy packages from the wheel into the \`site-packages\` directory"
hardlink\:"Hard link packages from the wheel into the \`site-packages\` directory"
...
copy\:"Copy packages from the wheel into the \`site-packages\` directory"
hardlink\:"Hard link packages from the wheel into the \`site-packages\` directory"
symlink\:"Symbolically link packages from the wheel into the \`site-packages\` directory"))' '*--refresh-package=[Refresh cached data for a specific package]:REFRESH_PACKAGE:_default' '*--group=[Install the specified dependency group from a \`pyproject.toml\`]:GROUP:_default' '-p+[The Python interpreter into which packages should be installed.]:PYTHON:_default' '--python=[The Python interpreter into which packages should be installed.]:PYTHON:_default' '(--prefix)--target=[Install packages into the specified directory, rather than into the virtual or system Python environment. The packages will be installed at the top-level of the directory]:TARGET:_files' '(--target)--prefix=[Install packages into \`lib\`, \`bin\`, and other top-level folders under the specified directory, as if a virtual environment were present at that location]:PREFIX:_files' '(--no-build)*--no-binary=[Don'\''t install pre-built wheels]:NO_BINARY:_default' '(--no-build)*--only-binary=[Only use pre-built wheels; don'\''t build source distributions]:ONLY_BINARY:_default' '--python-version=[The minimum Python version that should be supported by the requirements (e.g., \`3.7\` or \`3.7.9\`)]:PYTHON_VERSION:_default' '--python-platform=[The platform for which requirements should be installed]:PYTHON_PLATFORM:((windows\:"An alias for \`x86_64-pc-windows-msvc\`, the default target for Windows"
linux\:"An alias for \`x86_64-unknown-linux-gnu\`, the default target for Linux"
macos\:"An alias for \`aarch64-apple-darwin\`, the default target for macOS"
x86_64-pc-windows-msvc\:"A 64-bit x86 Windows target"
i686-pc-windows-msvc\:"A 32-bit x86 Windows target"
...
never\:"Do not ever allow Python downloads"))' '(--no-color)--color=[Control the use of color in output]:COLOR_CHOICE:((auto\:"Enables colored output only when the output is going to a terminal or TTY with support"
always\:"Enables colored output regardless of the detected environment"
never\:"Disables colored output"))' '*--allow-insecure-host=[Allow insecure connections to a host]:ALLOW_INSECURE_HOST:_default' '--directory=[Change to the given directory prior to running the command]:DIRECTORY:_files' '--project=[Run the command within the given project directory]:PROJECT:_files' '--config-file=[The path to a \`uv.toml\` file to use for configuration]:CONFIG_FILE:_files' '--system[Use the system Python to uninstall packages]' '--no-system[]' '--break-system-packages[Allow uv to modify an \`EXTERNALLY-MANAGED\` Python installation]' '--no-break-system-packages[]' '--dry-run[Perform a dry run, i.e., don'\''t actually uninstall anything but print the resulting plan]' '--disable-pip-version-check[]' '-n[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '--no-cache[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '(--python-preference)--managed-python[Require use of uv-managed Python versions]' '(--python-preference)--no-managed-python[Disable use of uv-managed Python versions]' '--allow-python-downloads[Allow automatically downloading Python when required. \[env\: "UV_PYTHON_DOWNLOADS=auto"\]]' '--no-python-downloads[Disable automatic downloads of Python. \[env\: "UV_PYTHON_DOWNLOADS=never"\]]' '(-v --verbose)*-q[Use quiet output]' '(-v --verbose)*--quiet[Use quiet output]' '(-q --quiet)*-v[Use verbose output]' '(-q --quiet)*--verbose[Use verbose output]' '(--color)--no-color[Disable colors]' '--native-tls[Whether to load TLS certificates from the platform'\''s native certificate store]' '--no-native-tls[]' '--offline[Disable network access]' '--no-offline[]' '--preview[Whether to enable experimental, preview features]' '--no-preview[]' '--isolated[Avoid discovering a \`pyproject.toml\` or \`uv.toml\` file]' '--show-settings[Show the resolved settings for the current command]' '--no-progress[Hide all progress outputs]' '--no-installer-metadata[Skip writing \`uv\` installer metadata files (e.g., \`INSTALLER\`, \`REQUESTED\`, and \`direct_url.json\`) to site-packages \`.dist-info\` directories]' '--no-config[Avoid discovering configuration files (\`pyproject.toml\`, \`uv.toml\`)]' '-h[Display the concise help for this command]' '--help[Display the concise help for this command]' '*::package -- Uninstall all listed packages:_default' && ret=0  ;;
...
never\:"Do not ever allow Python downloads"))' '(--no-color)--color=[Control the use of color in output]:COLOR_CHOICE:((auto\:"Enables colored output only when the output is going to a terminal or TTY with support"
always\:"Enables colored output regardless of the detected environment"
never\:"Disables colored output"))' '*--allow-insecure-host=[Allow insecure connections to a host]:ALLOW_INSECURE_HOST:_default' '--directory=[Change to the given directory prior to running the command]:DIRECTORY:_files' '--project=[Run the command within the given project directory]:PROJECT:_files' '--config-file=[The path to a \`uv.toml\` file to use for configuration]:CONFIG_FILE:_files' '--exclude-editable[Exclude any editable packages from output]' '--strict[Validate the Python environment, to detect packages with missing dependencies and other issues]' '--no-strict[]' '--system[List packages in the system Python environment]' '--no-system[]' '--disable-pip-version-check[]' '-n[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '--no-cache[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '(--python-preference)--managed-python[Require use of uv-managed Python versions]' '(--python-preference)--no-managed-python[Disable use of uv-managed Python versions]' '--allow-python-downloads[Allow automatically downloading Python when required. \[env\: "UV_PYTHON_DOWNLOADS=auto"\]]' '--no-python-downloads[Disable automatic downloads of Python. \[env\: "UV_PYTHON_DOWNLOADS=never"\]]' '(-v --verbose)*-q[Use quiet output]' '(-v --verbose)*--quiet[Use quiet output]' '(-q --quiet)*-v[Use verbose output]' '(-q --quiet)*--verbose[Use verbose output]' '(--color)--no-color[Disable colors]' '--native-tls[Whether to load TLS certificates from the platform'\''s native certificate store]' '--no-native-tls[]' '--offline[Disable network access]' '--no-offline[]' '--preview[Whether to enable experimental, preview features]' '--no-preview[]' '--isolated[Avoid discovering a \`pyproject.toml\` or \`uv.toml\` file]' '--show-settings[Show the resolved settings for the current command]' '--no-progress[Hide all progress outputs]' '--no-installer-metadata[Skip writing \`uv\` installer metadata files (e.g., \`INSTALLER\`, \`REQUESTED\`, and \`direct_url.json\`) to site-packages \`.dist-info\` directories]' '--no-config[Avoid discovering configuration files (\`pyproject.toml\`, \`uv.toml\`)]' '-h[Display the concise help for this command]' '--help[Display the concise help for this command]' && ret=0  ;;
...
never\:"Do not ever allow Python downloads"))' '(--no-color)--color=[Control the use of color in output]:COLOR_CHOICE:((auto\:"Enables colored output only when the output is going to a terminal or TTY with support"
always\:"Enables colored output regardless of the detected environment"
never\:"Disables colored output"))' '*--allow-insecure-host=[Allow insecure connections to a host]:ALLOW_INSECURE_HOST:_default' '--directory=[Change to the given directory prior to running the command]:DIRECTORY:_files' '--project=[Run the command within the given project directory]:PROJECT:_files' '--config-file=[The path to a \`uv.toml\` file to use for configuration]:CONFIG_FILE:_files' '-e[Only include editable projects]' '--editable[Only include editable projects]' '(-e --editable)--exclude-editable[Exclude any editable packages from output]' '--outdated[List outdated packages]' '--no-outdated[]' '--strict[Validate the Python environment, to detect packages with missing dependencies and other issues]' '--no-strict[]' '--no-index[Ignore the registry index (e.g., PyPI), instead relying on direct URL dependencies and those provided via \`--find-links\`]' '--system[List packages in the system Python environment]' '--no-system[]' '--disable-pip-version-check[]' '-n[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '--no-cache[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '(--python-preference)--managed-python[Require use of uv-managed Python versions]' '(--python-preference)--no-managed-python[Disable use of uv-managed Python versions]' '--allow-python-downloads[Allow automatically downloading Python when required. \[env\: "UV_PYTHON_DOWNLOADS=auto"\]]' '--no-python-downloads[Disable automatic downloads of Python. \[env\: "UV_PYTHON_DOWNLOADS=never"\]]' '(-v --verbose)*-q[Use quiet output]' '(-v --verbose)*--quiet[Use quiet output]' '(-q --quiet)*-v[Use verbose output]' '(-q --quiet)*--verbose[Use verbose output]' '(--color)--no-color[Disable colors]' '--native-tls[Whether to load TLS certificates from the platform'\''s native certificate store]' '--no-native-tls[]' '--offline[Disable network access]' '--no-offline[]' '--preview[Whether to enable experimental, preview features]' '--no-preview[]' '--isolated[Avoid discovering a \`pyproject.toml\` or \`uv.toml\` file]' '--show-settings[Show the resolved settings for the current command]' '--no-progress[Hide all progress outputs]' '--no-installer-metadata[Skip writing \`uv\` installer metadata files (e.g., \`INSTALLER\`, \`REQUESTED\`, and \`direct_url.json\`) to site-packages \`.dist-info\` directories]' '--no-config[Avoid discovering configuration files (\`pyproject.toml\`, \`uv.toml\`)]' '-h[Display the concise help for this command]' '--help[Display the concise help for this command]' && ret=0  ;;
...
never\:"Do not ever allow Python downloads"))' '(--no-color)--color=[Control the use of color in output]:COLOR_CHOICE:((auto\:"Enables colored output only when the output is going to a terminal or TTY with support"
always\:"Enables colored output regardless of the detected environment"
never\:"Disables colored output"))' '*--allow-insecure-host=[Allow insecure connections to a host]:ALLOW_INSECURE_HOST:_default' '--directory=[Change to the given directory prior to running the command]:DIRECTORY:_files' '--project=[Run the command within the given project directory]:PROJECT:_files' '--config-file=[The path to a \`uv.toml\` file to use for configuration]:CONFIG_FILE:_files' '--strict[Validate the Python environment, to detect packages with missing dependencies and other issues]' '--no-strict[]' '-f[Show the full list of installed files for each package]' '--files[Show the full list of installed files for each package]' '--system[Show a package in the system Python environment]' '--no-system[]' '--disable-pip-version-check[]' '-n[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '--no-cache[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '(--python-preference)--managed-python[Require use of uv-managed Python versions]' '(--python-preference)--no-managed-python[Disable use of uv-managed Python versions]' '--allow-python-downloads[Allow automatically downloading Python when required. \[env\: "UV_PYTHON_DOWNLOADS=auto"\]]' '--no-python-downloads[Disable automatic downloads of Python. \[env\: "UV_PYTHON_DOWNLOADS=never"\]]' '(-v --verbose)*-q[Use quiet output]' '(-v --verbose)*--quiet[Use quiet output]' '(-q --quiet)*-v[Use verbose output]' '(-q --quiet)*--verbose[Use verbose output]' '(--color)--no-color[Disable colors]' '--native-tls[Whether to load TLS certificates from the platform'\''s native certificate store]' '--no-native-tls[]' '--offline[Disable network access]' '--no-offline[]' '--preview[Whether to enable experimental, preview features]' '--no-preview[]' '--isolated[Avoid discovering a \`pyproject.toml\` or \`uv.toml\` file]' '--show-settings[Show the resolved settings for the current command]' '--no-progress[Hide all progress outputs]' '--no-installer-metadata[Skip writing \`uv\` installer metadata files (e.g., \`INSTALLER\`, \`REQUESTED\`, and \`direct_url.json\`) to site-packages \`.dist-info\` directories]' '--no-config[Avoid discovering configuration files (\`pyproject.toml\`, \`uv.toml\`)]' '-h[Display the concise help for this command]' '--help[Display the concise help for this command]' '*::package -- The package(s) to display:_default' && ret=0  ;;
...
never\:"Do not ever allow Python downloads"))' '(--no-color)--color=[Control the use of color in output]:COLOR_CHOICE:((auto\:"Enables colored output only when the output is going to a terminal or TTY with support"
always\:"Enables colored output regardless of the detected environment"
never\:"Disables colored output"))' '*--allow-insecure-host=[Allow insecure connections to a host]:ALLOW_INSECURE_HOST:_default' '--directory=[Change to the given directory prior to running the command]:DIRECTORY:_files' '--project=[Run the command within the given project directory]:PROJECT:_files' '--config-file=[The path to a \`uv.toml\` file to use for configuration]:CONFIG_FILE:_files' '--system[Check packages in the system Python environment]' '--no-system[]' '-n[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '--no-cache[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '(--python-preference)--managed-python[Require use of uv-managed Python versions]' '(--python-preference)--no-managed-python[Disable use of uv-managed Python versions]' '--allow-python-downloads[Allow automatically downloading Python when required. \[env\: "UV_PYTHON_DOWNLOADS=auto"\]]' '--no-python-downloads[Disable automatic downloads of Python. \[env\: "UV_PYTHON_DOWNLOADS=never"\]]' '(-v --verbose)*-q[Use quiet output]' '(-v --verbose)*--quiet[Use quiet output]' '(-q --quiet)*-v[Use verbose output]' '(-q --quiet)*--verbose[Use verbose output]' '(--color)--no-color[Disable colors]' '--native-tls[Whether to load TLS certificates from the platform'\''s native certificate store]' '--no-native-tls[]' '--offline[Disable network access]' '--no-offline[]' '--preview[Whether to enable experimental, preview features]' '--no-preview[]' '--isolated[Avoid discovering a \`pyproject.toml\` or \`uv.toml\` file]' '--show-settings[Show the resolved settings for the current command]' '--no-progress[Hide all progress outputs]' '--no-installer-metadata[Skip writing \`uv\` installer metadata files (e.g., \`INSTALLER\`, \`REQUESTED\`, and \`direct_url.json\`) to site-packages \`.dist-info\` directories]' '--no-config[Avoid discovering configuration files (\`pyproject.toml\`, \`uv.toml\`)]' '-h[Display the concise help for this command]' '--help[Display the concise help for this command]' && ret=0  ;;
							esac ;;
					esac ;;
...
never\:"Do not ever allow Python downloads"))' '(--no-color)--color=[Control the use of color in output]:COLOR_CHOICE:((auto\:"Enables colored output only when the output is going to a terminal or TTY with support"
always\:"Enables colored output regardless of the detected environment"
never\:"Disables colored output"))' '*--allow-insecure-host=[Allow insecure connections to a host]:ALLOW_INSECURE_HOST:_default' '--directory=[Change to the given directory prior to running the command]:DIRECTORY:_files' '--project=[Run the command within the given project directory]:PROJECT:_files' '--config-file=[The path to a \`uv.toml\` file to use for configuration]:CONFIG_FILE:_files' '--system[Ignore virtual environments when searching for the Python interpreter]' '--no-system[This flag is included for compatibility only, it has no effect]' '--no-project[Avoid discovering a project or workspace]' '--seed[Install seed packages (one or more of\: \`pip\`, \`setuptools\`, and \`wheel\`) into the virtual environment]' '--allow-existing[Preserve any existing files or directories at the target path]' '--system-site-packages[Give the virtual environment access to the system site packages directory]' '--relocatable[Make the virtual environment relocatable]' '--no-index[Ignore the registry index (e.g., PyPI), instead relying on direct URL dependencies and those provided via \`--find-links\`]' '(--offline)--refresh[Refresh all cached data]' '(--offline)--no-refresh[]' '--clear[]' '--no-seed[]' '--no-pip[]' '--no-setuptools[]' '--no-wheel[]' '-n[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '--no-cache[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '(--python-preference)--managed-python[Require use of uv-managed Python versions]' '(--python-preference)--no-managed-python[Disable use of uv-managed Python versions]' '--allow-python-downloads[Allow automatically downloading Python when required. \[env\: "UV_PYTHON_DOWNLOADS=auto"\]]' '--no-python-downloads[Disable automatic downloads of Python. \[env\: "UV_PYTHON_DOWNLOADS=never"\]]' '(-v --verbose)*-q[Use quiet output]' '(-v --verbose)*--quiet[Use quiet output]' '(-q --quiet)*-v[Use verbose output]' '(-q --quiet)*--verbose[Use verbose output]' '(--color)--no-color[Disable colors]' '--native-tls[Whether to load TLS certificates from the platform'\''s native certificate store]' '--no-native-tls[]' '--offline[Disable network access]' '--no-offline[]' '--preview[Whether to enable experimental, preview features]' '--no-preview[]' '--isolated[Avoid discovering a \`pyproject.toml\` or \`uv.toml\` file]' '--show-settings[Show the resolved settings for the current command]' '--no-progress[Hide all progress outputs]' '--no-installer-metadata[Skip writing \`uv\` installer metadata files (e.g., \`INSTALLER\`, \`REQUESTED\`, and \`direct_url.json\`) to site-packages \`.dist-info\` directories]' '--no-config[Avoid discovering configuration files (\`pyproject.toml\`, \`uv.toml\`)]' '-h[Display the concise help for this command]' '--help[Display the concise help for this command]' '::path -- The path to the virtual environment to create:_files' && ret=0  ;;
...
never\:"Do not ever allow Python downloads"))' '(--no-color)--color=[Control the use of color in output]:COLOR_CHOICE:((auto\:"Enables colored output only when the output is going to a terminal or TTY with support"
always\:"Enables colored output regardless of the detected environment"
never\:"Disables colored output"))' '*--allow-insecure-host=[Allow insecure connections to a host]:ALLOW_INSECURE_HOST:_default' '--directory=[Change to the given directory prior to running the command]:DIRECTORY:_files' '--project=[Run the command within the given project directory]:PROJECT:_files' '--config-file=[The path to a \`uv.toml\` file to use for configuration]:CONFIG_FILE:_files' '(--package)--all-packages[Builds all packages in the workspace]' '--sdist[Build a source distribution ("sdist") from the given directory]' '--wheel[Build a binary distribution ("wheel") from the given directory]' '--list[When using the uv build backend, list the files that would be included when building]' '--build-logs[]' '--no-build-logs[Hide logs from the build backend]' '(--list)--force-pep517[Always build through PEP 517, don'\''t use the fast path for the uv build backend]' '--require-hashes[Require a matching hash for each requirement]' '--no-require-hashes[]' '--verify-hashes[]' '--no-verify-hashes[Disable validation of hashes in the requirements file]' '--no-index[Ignore the registry index (e.g., PyPI), instead relying on direct URL dependencies and those provided via \`--find-links\`]' '-U[Allow package upgrades, ignoring pinned versions in any existing output file. Implies \`--refresh\`]' '--upgrade[Allow package upgrades, ignoring pinned versions in any existing output file. Implies \`--refresh\`]' '--no-upgrade[]' '--pre[]' '--no-build-isolation[Disable isolation when building source distributions]' '--build-isolation[]' '--no-sources[Ignore the \`tool.uv.sources\` table when resolving dependencies. Used to lock against the standards-compliant, publishable package metadata, as opposed to using any workspace, Git, URL, or local path sources]' '--no-build[Don'\''t build source distributions]' '--build[]' '--no-binary[Don'\''t install pre-built wheels]' '--binary[]' '(--offline)--refresh[Refresh all cached data]' '(--offline)--no-refresh[]' '-n[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '--no-cache[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '(--python-preference)--managed-python[Require use of uv-managed Python versions]' '(--python-preference)--no-managed-python[Disable use of uv-managed Python versions]' '--allow-python-downloads[Allow automatically downloading Python when required. \[env\: "UV_PYTHON_DOWNLOADS=auto"\]]' '--no-python-downloads[Disable automatic downloads of Python. \[env\: "UV_PYTHON_DOWNLOADS=never"\]]' '(-v --verbose)*-q[Use quiet output]' '(-v --verbose)*--quiet[Use quiet output]' '(-q --quiet)*-v[Use verbose output]' '(-q --quiet)*--verbose[Use verbose output]' '(--color)--no-color[Disable colors]' '--native-tls[Whether to load TLS certificates from the platform'\''s native certificate store]' '--no-native-tls[]' '--offline[Disable network access]' '--no-offline[]' '--preview[Whether to enable experimental, preview features]' '--no-preview[]' '--isolated[Avoid discovering a \`pyproject.toml\` or \`uv.toml\` file]' '--show-settings[Show the resolved settings for the current command]' '--no-progress[Hide all progress outputs]' '--no-installer-metadata[Skip writing \`uv\` installer metadata files (e.g., \`INSTALLER\`, \`REQUESTED\`, and \`direct_url.json\`) to site-packages \`.dist-info\` directories]' '--no-config[Avoid discovering configuration files (\`pyproject.toml\`, \`uv.toml\`)]' '-h[Display the concise help for this command]' '--help[Display the concise help for this command]' '::src -- The directory from which distributions should be built, or a source distribution archive to build into a wheel:_files' && ret=0  ;;
...
never\:"Do not ever allow Python downloads"))' '(--no-color)--color=[Control the use of color in output]:COLOR_CHOICE:((auto\:"Enables colored output only when the output is going to a terminal or TTY with support"
always\:"Enables colored output regardless of the detected environment"
never\:"Disables colored output"))' '*--allow-insecure-host=[Allow insecure connections to a host]:ALLOW_INSECURE_HOST:_default' '--directory=[Change to the given directory prior to running the command]:DIRECTORY:_files' '--project=[Run the command within the given project directory]:PROJECT:_files' '--config-file=[The path to a \`uv.toml\` file to use for configuration]:CONFIG_FILE:_files' '--skip-existing[]' '-n[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '--no-cache[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '(--python-preference)--managed-python[Require use of uv-managed Python versions]' '(--python-preference)--no-managed-python[Disable use of uv-managed Python versions]' '--allow-python-downloads[Allow automatically downloading Python when required. \[env\: "UV_PYTHON_DOWNLOADS=auto"\]]' '--no-python-downloads[Disable automatic downloads of Python. \[env\: "UV_PYTHON_DOWNLOADS=never"\]]' '(-v --verbose)*-q[Use quiet output]' '(-v --verbose)*--quiet[Use quiet output]' '(-q --quiet)*-v[Use verbose output]' '(-q --quiet)*--verbose[Use verbose output]' '(--color)--no-color[Disable colors]' '--native-tls[Whether to load TLS certificates from the platform'\''s native certificate store]' '--no-native-tls[]' '--offline[Disable network access]' '--no-offline[]' '--preview[Whether to enable experimental, preview features]' '--no-preview[]' '--isolated[Avoid discovering a \`pyproject.toml\` or \`uv.toml\` file]' '--show-settings[Show the resolved settings for the current command]' '--no-progress[Hide all progress outputs]' '--no-installer-metadata[Skip writing \`uv\` installer metadata files (e.g., \`INSTALLER\`, \`REQUESTED\`, and \`direct_url.json\`) to site-packages \`.dist-info\` directories]' '--no-config[Avoid discovering configuration files (\`pyproject.toml\`, \`uv.toml\`)]' '-h[Display the concise help for this command]' '--help[Display the concise help for this command]' '*::files -- Paths to the files to upload. Accepts glob expressions:_default' && ret=0  ;;
...
never\:"Do not ever allow Python downloads"))' '(--no-color)--color=[Control the use of color in output]:COLOR_CHOICE:((auto\:"Enables colored output only when the output is going to a terminal or TTY with support"
always\:"Enables colored output regardless of the detected environment"
never\:"Disables colored output"))' '*--allow-insecure-host=[Allow insecure connections to a host]:ALLOW_INSECURE_HOST:_default' '--directory=[Change to the given directory prior to running the command]:DIRECTORY:_files' '--project=[Run the command within the given project directory]:PROJECT:_files' '--config-file=[The path to a \`uv.toml\` file to use for configuration]:CONFIG_FILE:_files' '--ci[Optimize the cache for persistence in a continuous integration environment, like GitHub Actions]' '-n[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '--no-cache[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '(--python-preference)--managed-python[Require use of uv-managed Python versions]' '(--python-preference)--no-managed-python[Disable use of uv-managed Python versions]' '--allow-python-downloads[Allow automatically downloading Python when required. \[env\: "UV_PYTHON_DOWNLOADS=auto"\]]' '--no-python-downloads[Disable automatic downloads of Python. \[env\: "UV_PYTHON_DOWNLOADS=never"\]]' '(-v --verbose)*-q[Use quiet output]' '(-v --verbose)*--quiet[Use quiet output]' '(-q --quiet)*-v[Use verbose output]' '(-q --quiet)*--verbose[Use verbose output]' '(--color)--no-color[Disable colors]' '--native-tls[Whether to load TLS certificates from the platform'\''s native certificate store]' '--no-native-tls[]' '--offline[Disable network access]' '--no-offline[]' '--preview[Whether to enable experimental, preview features]' '--no-preview[]' '--isolated[Avoid discovering a \`pyproject.toml\` or \`uv.toml\` file]' '--show-settings[Show the resolved settings for the current command]' '--no-progress[Hide all progress outputs]' '--no-installer-metadata[Skip writing \`uv\` installer metadata files (e.g., \`INSTALLER\`, \`REQUESTED\`, and \`direct_url.json\`) to site-packages \`.dist-info\` directories]' '--no-config[Avoid discovering configuration files (\`pyproject.toml\`, \`uv.toml\`)]' '-h[Display the concise help for this command]' '--help[Display the concise help for this command]' && ret=0  ;;
								(dir) _arguments "${_arguments_options[@]}" : '--cache-dir=[Path to the cache directory]:CACHE_DIR:_files' '--python-preference=[]:PYTHON_PREFERENCE:((only-managed\:"Only use managed Python installations; never use system Python installations"
managed\:"Prefer managed Python installations over system Python installations"
system\:"Prefer system Python installations over managed Python installations"
only-system\:"Only use system Python installations; never use managed Python installations"))' '--python-fetch=[Deprecated version of \[\`Self\:\:python_downloads\`\]]:PYTHON_FETCH:((automatic\:"Automatically download managed Python installations when needed"
...
never\:"Do not ever allow Python downloads"))' '(--no-color)--color=[Control the use of color in output]:COLOR_CHOICE:((auto\:"Enables colored output only when the output is going to a terminal or TTY with support"
always\:"Enables colored output regardless of the detected environment"
never\:"Disables colored output"))' '*--allow-insecure-host=[Allow insecure connections to a host]:ALLOW_INSECURE_HOST:_default' '--directory=[Change to the given directory prior to running the command]:DIRECTORY:_files' '--project=[Run the command within the given project directory]:PROJECT:_files' '--config-file=[The path to a \`uv.toml\` file to use for configuration]:CONFIG_FILE:_files' '--dry-run[Run without performing the update]' '-n[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '--no-cache[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '(--python-preference)--managed-python[Require use of uv-managed Python versions]' '(--python-preference)--no-managed-python[Disable use of uv-managed Python versions]' '--allow-python-downloads[Allow automatically downloading Python when required. \[env\: "UV_PYTHON_DOWNLOADS=auto"\]]' '--no-python-downloads[Disable automatic downloads of Python. \[env\: "UV_PYTHON_DOWNLOADS=never"\]]' '(-v --verbose)*-q[Use quiet output]' '(-v --verbose)*--quiet[Use quiet output]' '(-q --quiet)*-v[Use verbose output]' '(-q --quiet)*--verbose[Use verbose output]' '(--color)--no-color[Disable colors]' '--native-tls[Whether to load TLS certificates from the platform'\''s native certificate store]' '--no-native-tls[]' '--offline[Disable network access]' '--no-offline[]' '--preview[Whether to enable experimental, preview features]' '--no-preview[]' '--isolated[Avoid discovering a \`pyproject.toml\` or \`uv.toml\` file]' '--show-settings[Show the resolved settings for the current command]' '--no-progress[Hide all progress outputs]' '--no-installer-metadata[Skip writing \`uv\` installer metadata files (e.g., \`INSTALLER\`, \`REQUESTED\`, and \`direct_url.json\`) to site-packages \`.dist-info\` directories]' '--no-config[Avoid discovering configuration files (\`pyproject.toml\`, \`uv.toml\`)]' '-h[Display the concise help for this command]' '--help[Display the concise help for this command]' '::target_version -- Update to the specified version. If not provided, uv will update to the latest version:_default' && ret=0  ;;
...
never\:"Do not ever allow Python downloads"))' '(--no-color)--color=[Control the use of color in output]:COLOR_CHOICE:((auto\:"Enables colored output only when the output is going to a terminal or TTY with support"
always\:"Enables colored output regardless of the detected environment"
never\:"Disables colored output"))' '*--allow-insecure-host=[Allow insecure connections to a host]:ALLOW_INSECURE_HOST:_default' '--directory=[Change to the given directory prior to running the command]:DIRECTORY:_files' '--project=[Run the command within the given project directory]:PROJECT:_files' '--config-file=[The path to a \`uv.toml\` file to use for configuration]:CONFIG_FILE:_files' '--short[Only print the version]' '-n[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '--no-cache[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '(--python-preference)--managed-python[Require use of uv-managed Python versions]' '(--python-preference)--no-managed-python[Disable use of uv-managed Python versions]' '--allow-python-downloads[Allow automatically downloading Python when required. \[env\: "UV_PYTHON_DOWNLOADS=auto"\]]' '--no-python-downloads[Disable automatic downloads of Python. \[env\: "UV_PYTHON_DOWNLOADS=never"\]]' '(-v --verbose)*-q[Use quiet output]' '(-v --verbose)*--quiet[Use quiet output]' '(-q --quiet)*-v[Use verbose output]' '(-q --quiet)*--verbose[Use verbose output]' '(--color)--no-color[Disable colors]' '--native-tls[Whether to load TLS certificates from the platform'\''s native certificate store]' '--no-native-tls[]' '--offline[Disable network access]' '--no-offline[]' '--preview[Whether to enable experimental, preview features]' '--no-preview[]' '--isolated[Avoid discovering a \`pyproject.toml\` or \`uv.toml\` file]' '--show-settings[Show the resolved settings for the current command]' '--no-progress[Hide all progress outputs]' '--no-installer-metadata[Skip writing \`uv\` installer metadata files (e.g., \`INSTALLER\`, \`REQUESTED\`, and \`direct_url.json\`) to site-packages \`.dist-info\` directories]' '--no-config[Avoid discovering configuration files (\`pyproject.toml\`, \`uv.toml\`)]' '-h[Display the concise help for this command]' '--help[Display the concise help for this command]' && ret=0  ;;
							esac ;;
					esac ;;
				(clean) _arguments "${_arguments_options[@]}" : '--cache-dir=[Path to the cache directory]:CACHE_DIR:_files' '--python-preference=[]:PYTHON_PREFERENCE:((only-managed\:"Only use managed Python installations; never use system Python installations"
managed\:"Prefer managed Python installations over system Python installations"
...
manual\:"Do not automatically download managed Python installations; require explicit installation"
never\:"Do not ever allow Python downloads"))' '*--allow-insecure-host=[Allow insecure connections to a host]:ALLOW_INSECURE_HOST:_default' '--directory=[Change to the given directory prior to running the command]:DIRECTORY:_files' '--project=[Run the command within the given project directory]:PROJECT:_files' '-n[]' '--no-cache[]' '--no-python-downloads[]' '(-v --verbose)*-q[]' '(-v --verbose)*--quiet[]' '(-q --quiet)*-v[]' '(-q --quiet)*--verbose[]' '--native-tls[]' '--offline[]' '--no-progress[]' '--no-config[]' '-h[]' '--help[]' '-V[]' '--version[]' '(--python-preference)--managed-python[Require use of uv-managed Python versions]' '(--python-preference)--no-managed-python[Disable use of uv-managed Python versions]' '--allow-python-downloads[Allow automatically downloading Python when required. \[env\: "UV_PYTHON_DOWNLOADS=auto"\]]' '(--color)--no-color[Disable colors]' '--no-native-tls[]' '--no-offline[]' '--preview[Whether to enable experimental, preview features]' '--no-preview[]' '--isolated[Avoid discovering a \`pyproject.toml\` or \`uv.toml\` file]' '--show-settings[Show the resolved settings for the current command]' '--no-installer-metadata[Skip writing \`uv\` installer metadata files (e.g., \`INSTALLER\`, \`REQUESTED\`, and \`direct_url.json\`) to site-packages \`.dist-info\` directories]' ':shell -- The shell to generate the completion script for:(bash elvish fish nushell powershell zsh)' && ret=0  ;;
...
never\:"Do not ever allow Python downloads"))' '(--no-color)--color=[Control the use of color in output]:COLOR_CHOICE:((auto\:"Enables colored output only when the output is going to a terminal or TTY with support"
always\:"Enables colored output regardless of the detected environment"
never\:"Disables colored output"))' '*--allow-insecure-host=[Allow insecure connections to a host]:ALLOW_INSECURE_HOST:_default' '--directory=[Change to the given directory prior to running the command]:DIRECTORY:_files' '--project=[Run the command within the given project directory]:PROJECT:_files' '--config-file=[The path to a \`uv.toml\` file to use for configuration]:CONFIG_FILE:_files' '--no-pager[Disable pager when printing help]' '-n[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '--no-cache[Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation]' '(--python-preference)--managed-python[Require use of uv-managed Python versions]' '(--python-preference)--no-managed-python[Disable use of uv-managed Python versions]' '--allow-python-downloads[Allow automatically downloading Python when required. \[env\: "UV_PYTHON_DOWNLOADS=auto"\]]' '--no-python-downloads[Disable automatic downloads of Python. \[env\: "UV_PYTHON_DOWNLOADS=never"\]]' '(-v --verbose)*-q[Use quiet output]' '(-v --verbose)*--quiet[Use quiet output]' '(-q --quiet)*-v[Use verbose output]' '(-q --quiet)*--verbose[Use verbose output]' '(--color)--no-color[Disable colors]' '--native-tls[Whether to load TLS certificates from the platform'\''s native certificate store]' '--no-native-tls[]' '--offline[Disable network access]' '--no-offline[]' '--preview[Whether to enable experimental, preview features]' '--no-preview[]' '--isolated[Avoid discovering a \`pyproject.toml\` or \`uv.toml\` file]' '--show-settings[Show the resolved settings for the current command]' '--no-progress[Hide all progress outputs]' '--no-installer-metadata[Skip writing \`uv\` installer metadata files (e.g., \`INSTALLER\`, \`REQUESTED\`, and \`direct_url.json\`) to site-packages \`.dist-info\` directories]' '--no-config[Avoid discovering configuration files (\`pyproject.toml\`, \`uv.toml\`)]' '-h[Display the concise help for this command]' '--help[Display the concise help for this command]' '*::command:_default' && ret=0  ;;
			esac ;;
	esac
}
_uv__add_commands () {
...
_zsh_highlight_widget_orig-s000-r988-_bash_complete-word () {
	_zsh_highlight_call_widget orig-s000-r988-_bash_complete-word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-_bash_list-choices () {
	_zsh_highlight_call_widget orig-s000-r988-_bash_list-choices -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-_complete_debug () {
	_zsh_highlight_call_widget orig-s000-r988-_complete_debug -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-_complete_help () {
	_zsh_highlight_call_widget orig-s000-r988-_complete_help -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-_complete_tag () {
	_zsh_highlight_call_widget orig-s000-r988-_complete_tag -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-_correct_filename () {
	_zsh_highlight_call_widget orig-s000-r988-_correct_filename -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-_correct_word () {
	_zsh_highlight_call_widget orig-s000-r988-_correct_word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-_expand_alias () {
	_zsh_highlight_call_widget orig-s000-r988-_expand_alias -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-_expand_word () {
	_zsh_highlight_call_widget orig-s000-r988-_expand_word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-_fzf-tab-apply () {
	_zsh_highlight_call_widget orig-s000-r988-_fzf-tab-apply -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-_history-complete-newer () {
	_zsh_highlight_call_widget orig-s000-r988-_history-complete-newer -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-_history-complete-older () {
	_zsh_highlight_call_widget orig-s000-r988-_history-complete-older -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-_list_expansions () {
	_zsh_highlight_call_widget orig-s000-r988-_list_expansions -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-_most_recent_file () {
	_zsh_highlight_call_widget orig-s000-r988-_most_recent_file -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-_next_tags () {
	_zsh_highlight_call_widget orig-s000-r988-_next_tags -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-_read_comp () {
	_zsh_highlight_call_widget orig-s000-r988-_read_comp -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-accept-and-hold () {
	_zsh_highlight_call_widget .accept-and-hold -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-accept-and-infer-next-history () {
	_zsh_highlight_call_widget .accept-and-infer-next-history -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-accept-and-menu-complete () {
	_zsh_highlight_call_widget .accept-and-menu-complete -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-accept-line () {
	_zsh_highlight_call_widget .accept-line -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-accept-line-and-down-history () {
	_zsh_highlight_call_widget .accept-line-and-down-history -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-accept-search () {
	_zsh_highlight_call_widget .accept-search -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-argument-base () {
	_zsh_highlight_call_widget .argument-base -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-auto-suffix-remove () {
	_zsh_highlight_call_widget .auto-suffix-remove -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-auto-suffix-retain () {
	_zsh_highlight_call_widget .auto-suffix-retain -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-backward-char () {
	_zsh_highlight_call_widget .backward-char -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-backward-delete-char () {
	_zsh_highlight_call_widget .backward-delete-char -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-backward-delete-word () {
	_zsh_highlight_call_widget .backward-delete-word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-backward-kill-line () {
	_zsh_highlight_call_widget .backward-kill-line -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-backward-kill-word () {
	_zsh_highlight_call_widget .backward-kill-word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-backward-word () {
	_zsh_highlight_call_widget .backward-word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-beginning-of-buffer-or-history () {
	_zsh_highlight_call_widget .beginning-of-buffer-or-history -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-beginning-of-history () {
	_zsh_highlight_call_widget .beginning-of-history -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-beginning-of-line () {
	_zsh_highlight_call_widget .beginning-of-line -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-beginning-of-line-hist () {
	_zsh_highlight_call_widget .beginning-of-line-hist -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-bracketed-paste () {
	_zsh_highlight_call_widget .bracketed-paste -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-capitalize-word () {
	_zsh_highlight_call_widget .capitalize-word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-clear-screen () {
	_zsh_highlight_call_widget .clear-screen -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-complete-word () {
	_zsh_highlight_call_widget orig-s000-r988-complete-word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-copy-prev-shell-word () {
	_zsh_highlight_call_widget .copy-prev-shell-word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-copy-prev-word () {
	_zsh_highlight_call_widget .copy-prev-word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-copy-region-as-kill () {
	_zsh_highlight_call_widget .copy-region-as-kill -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-deactivate-region () {
	_zsh_highlight_call_widget .deactivate-region -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-delete-char () {
	_zsh_highlight_call_widget .delete-char -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-delete-char-or-list () {
	_zsh_highlight_call_widget orig-s000-r988-delete-char-or-list -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-delete-word () {
	_zsh_highlight_call_widget .delete-word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-describe-key-briefly () {
	_zsh_highlight_call_widget .describe-key-briefly -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-digit-argument () {
	_zsh_highlight_call_widget .digit-argument -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-down-case-word () {
	_zsh_highlight_call_widget .down-case-word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-down-history () {
	_zsh_highlight_call_widget .down-history -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-down-line () {
	_zsh_highlight_call_widget .down-line -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-down-line-or-history () {
	_zsh_highlight_call_widget .down-line-or-history -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-down-line-or-search () {
	_zsh_highlight_call_widget .down-line-or-search -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-emacs-backward-word () {
	_zsh_highlight_call_widget .emacs-backward-word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-emacs-forward-word () {
	_zsh_highlight_call_widget .emacs-forward-word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-end-of-buffer-or-history () {
	_zsh_highlight_call_widget .end-of-buffer-or-history -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-end-of-history () {
	_zsh_highlight_call_widget .end-of-history -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-end-of-line () {
	_zsh_highlight_call_widget .end-of-line -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-end-of-line-hist () {
	_zsh_highlight_call_widget .end-of-line-hist -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-end-of-list () {
	_zsh_highlight_call_widget .end-of-list -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-exchange-point-and-mark () {
	_zsh_highlight_call_widget .exchange-point-and-mark -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-execute-last-named-cmd () {
	_zsh_highlight_call_widget .execute-last-named-cmd -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-execute-named-cmd () {
	_zsh_highlight_call_widget .execute-named-cmd -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-expand-cmd-path () {
	_zsh_highlight_call_widget .expand-cmd-path -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-expand-history () {
	_zsh_highlight_call_widget .expand-history -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-expand-or-complete () {
	_zsh_highlight_call_widget orig-s000-r988-expand-or-complete -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-expand-or-complete-prefix () {
	_zsh_highlight_call_widget orig-s000-r988-expand-or-complete-prefix -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-expand-word () {
	_zsh_highlight_call_widget .expand-word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-forward-char () {
	_zsh_highlight_call_widget .forward-char -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-forward-word () {
	_zsh_highlight_call_widget .forward-word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-fzf-tab-complete () {
	_zsh_highlight_call_widget orig-s000-r988-fzf-tab-complete -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-fzf-tab-debug () {
	_zsh_highlight_call_widget orig-s000-r988-fzf-tab-debug -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-fzf-tab-dummy () {
	_zsh_highlight_call_widget orig-s000-r988-fzf-tab-dummy -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-get-line () {
	_zsh_highlight_call_widget .get-line -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-gosmacs-transpose-chars () {
	_zsh_highlight_call_widget .gosmacs-transpose-chars -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-history-beginning-search-backward () {
	_zsh_highlight_call_widget .history-beginning-search-backward -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-history-beginning-search-forward () {
	_zsh_highlight_call_widget .history-beginning-search-forward -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-history-incremental-pattern-search-backward () {
	_zsh_highlight_call_widget .history-incremental-pattern-search-backward -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-history-incremental-pattern-search-forward () {
	_zsh_highlight_call_widget .history-incremental-pattern-search-forward -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-history-incremental-search-backward () {
	_zsh_highlight_call_widget .history-incremental-search-backward -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-history-incremental-search-forward () {
	_zsh_highlight_call_widget .history-incremental-search-forward -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-history-search-backward () {
	_zsh_highlight_call_widget .history-search-backward -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-history-search-forward () {
	_zsh_highlight_call_widget .history-search-forward -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-infer-next-history () {
	_zsh_highlight_call_widget .infer-next-history -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-insert-last-word () {
	_zsh_highlight_call_widget .insert-last-word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-kill-buffer () {
	_zsh_highlight_call_widget .kill-buffer -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-kill-line () {
	_zsh_highlight_call_widget .kill-line -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-kill-region () {
	_zsh_highlight_call_widget .kill-region -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-kill-whole-line () {
	_zsh_highlight_call_widget .kill-whole-line -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-kill-word () {
	_zsh_highlight_call_widget .kill-word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-list-choices () {
	_zsh_highlight_call_widget orig-s000-r988-list-choices -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-list-expand () {
	_zsh_highlight_call_widget .list-expand -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-magic-space () {
	_zsh_highlight_call_widget .magic-space -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-menu-complete () {
	_zsh_highlight_call_widget orig-s000-r988-menu-complete -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-menu-expand-or-complete () {
	_zsh_highlight_call_widget orig-s000-r988-menu-expand-or-complete -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-neg-argument () {
	_zsh_highlight_call_widget .neg-argument -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-overwrite-mode () {
	_zsh_highlight_call_widget .overwrite-mode -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-pound-insert () {
	_zsh_highlight_call_widget .pound-insert -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-push-input () {
	_zsh_highlight_call_widget .push-input -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-push-line () {
	_zsh_highlight_call_widget .push-line -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-push-line-or-edit () {
	_zsh_highlight_call_widget .push-line-or-edit -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-put-replace-selection () {
	_zsh_highlight_call_widget .put-replace-selection -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-quote-line () {
	_zsh_highlight_call_widget .quote-line -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-quote-region () {
	_zsh_highlight_call_widget .quote-region -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-quoted-insert () {
	_zsh_highlight_call_widget .quoted-insert -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-read-command () {
	_zsh_highlight_call_widget .read-command -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-recursive-edit () {
	_zsh_highlight_call_widget .recursive-edit -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-redisplay () {
	_zsh_highlight_call_widget .redisplay -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-redo () {
	_zsh_highlight_call_widget .redo -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-reset-prompt () {
	_zsh_highlight_call_widget .reset-prompt -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-reverse-menu-complete () {
	_zsh_highlight_call_widget orig-s000-r988-reverse-menu-complete -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-select-a-blank-word () {
	_zsh_highlight_call_widget .select-a-blank-word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-select-a-shell-word () {
	_zsh_highlight_call_widget .select-a-shell-word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-select-a-word () {
	_zsh_highlight_call_widget .select-a-word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-select-in-blank-word () {
	_zsh_highlight_call_widget .select-in-blank-word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-select-in-shell-word () {
	_zsh_highlight_call_widget .select-in-shell-word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-select-in-word () {
	_zsh_highlight_call_widget .select-in-word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-self-insert () {
	_zsh_highlight_call_widget .self-insert -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-self-insert-unmeta () {
	_zsh_highlight_call_widget .self-insert-unmeta -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-send-break () {
	_zsh_highlight_call_widget .send-break -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-sesh-sessions () {
	_zsh_highlight_call_widget orig-s000-r988-sesh-sessions -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-set-mark-command () {
	_zsh_highlight_call_widget .set-mark-command -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-spell-word () {
	_zsh_highlight_call_widget .spell-word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-split-undo () {
	_zsh_highlight_call_widget .split-undo -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-toggle-fzf-tab () {
	_zsh_highlight_call_widget orig-s000-r988-toggle-fzf-tab -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-transpose-chars () {
	_zsh_highlight_call_widget .transpose-chars -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-transpose-words () {
	_zsh_highlight_call_widget .transpose-words -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-undefined-key () {
	_zsh_highlight_call_widget .undefined-key -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-undo () {
	_zsh_highlight_call_widget .undo -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-universal-argument () {
	_zsh_highlight_call_widget .universal-argument -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-up-case-word () {
	_zsh_highlight_call_widget .up-case-word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-up-history () {
	_zsh_highlight_call_widget .up-history -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-up-line () {
	_zsh_highlight_call_widget .up-line -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-up-line-or-history () {
	_zsh_highlight_call_widget .up-line-or-history -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-up-line-or-search () {
	_zsh_highlight_call_widget .up-line-or-search -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-add-eol () {
	_zsh_highlight_call_widget .vi-add-eol -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-add-next () {
	_zsh_highlight_call_widget .vi-add-next -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-backward-blank-word () {
	_zsh_highlight_call_widget .vi-backward-blank-word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-backward-blank-word-end () {
	_zsh_highlight_call_widget .vi-backward-blank-word-end -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-backward-char () {
	_zsh_highlight_call_widget .vi-backward-char -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-backward-delete-char () {
	_zsh_highlight_call_widget .vi-backward-delete-char -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-backward-kill-word () {
	_zsh_highlight_call_widget .vi-backward-kill-word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-backward-word () {
	_zsh_highlight_call_widget .vi-backward-word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-backward-word-end () {
	_zsh_highlight_call_widget .vi-backward-word-end -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-beginning-of-line () {
	_zsh_highlight_call_widget .vi-beginning-of-line -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-caps-lock-panic () {
	_zsh_highlight_call_widget .vi-caps-lock-panic -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-change () {
	_zsh_highlight_call_widget .vi-change -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-change-eol () {
	_zsh_highlight_call_widget .vi-change-eol -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-change-whole-line () {
	_zsh_highlight_call_widget .vi-change-whole-line -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-cmd-mode () {
	_zsh_highlight_call_widget .vi-cmd-mode -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-delete () {
	_zsh_highlight_call_widget .vi-delete -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-delete-char () {
	_zsh_highlight_call_widget .vi-delete-char -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-digit-or-beginning-of-line () {
	_zsh_highlight_call_widget .vi-digit-or-beginning-of-line -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-down-case () {
	_zsh_highlight_call_widget .vi-down-case -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-down-line-or-history () {
	_zsh_highlight_call_widget .vi-down-line-or-history -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-end-of-line () {
	_zsh_highlight_call_widget .vi-end-of-line -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-fetch-history () {
	_zsh_highlight_call_widget .vi-fetch-history -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-find-next-char () {
	_zsh_highlight_call_widget .vi-find-next-char -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-find-next-char-skip () {
	_zsh_highlight_call_widget .vi-find-next-char-skip -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-find-prev-char () {
	_zsh_highlight_call_widget .vi-find-prev-char -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-find-prev-char-skip () {
	_zsh_highlight_call_widget .vi-find-prev-char-skip -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-first-non-blank () {
	_zsh_highlight_call_widget .vi-first-non-blank -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-forward-blank-word () {
	_zsh_highlight_call_widget .vi-forward-blank-word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-forward-blank-word-end () {
	_zsh_highlight_call_widget .vi-forward-blank-word-end -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-forward-char () {
	_zsh_highlight_call_widget .vi-forward-char -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-forward-word () {
	_zsh_highlight_call_widget .vi-forward-word -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-forward-word-end () {
	_zsh_highlight_call_widget .vi-forward-word-end -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-goto-column () {
	_zsh_highlight_call_widget .vi-goto-column -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-goto-mark () {
	_zsh_highlight_call_widget .vi-goto-mark -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-goto-mark-line () {
	_zsh_highlight_call_widget .vi-goto-mark-line -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-history-search-backward () {
	_zsh_highlight_call_widget .vi-history-search-backward -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-history-search-forward () {
	_zsh_highlight_call_widget .vi-history-search-forward -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-indent () {
	_zsh_highlight_call_widget .vi-indent -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-insert () {
	_zsh_highlight_call_widget .vi-insert -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-insert-bol () {
	_zsh_highlight_call_widget .vi-insert-bol -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-join () {
	_zsh_highlight_call_widget .vi-join -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-kill-eol () {
	_zsh_highlight_call_widget .vi-kill-eol -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-kill-line () {
	_zsh_highlight_call_widget .vi-kill-line -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-match-bracket () {
	_zsh_highlight_call_widget .vi-match-bracket -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-open-line-above () {
	_zsh_highlight_call_widget .vi-open-line-above -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-open-line-below () {
	_zsh_highlight_call_widget .vi-open-line-below -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-oper-swap-case () {
	_zsh_highlight_call_widget .vi-oper-swap-case -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-pound-insert () {
	_zsh_highlight_call_widget .vi-pound-insert -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-put-after () {
	_zsh_highlight_call_widget .vi-put-after -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-put-before () {
	_zsh_highlight_call_widget .vi-put-before -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-quoted-insert () {
	_zsh_highlight_call_widget .vi-quoted-insert -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-repeat-change () {
	_zsh_highlight_call_widget .vi-repeat-change -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-repeat-find () {
	_zsh_highlight_call_widget .vi-repeat-find -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-repeat-search () {
	_zsh_highlight_call_widget .vi-repeat-search -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-replace () {
	_zsh_highlight_call_widget .vi-replace -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-replace-chars () {
	_zsh_highlight_call_widget .vi-replace-chars -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-rev-repeat-find () {
	_zsh_highlight_call_widget .vi-rev-repeat-find -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-rev-repeat-search () {
	_zsh_highlight_call_widget .vi-rev-repeat-search -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-set-buffer () {
	_zsh_highlight_call_widget .vi-set-buffer -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-set-mark () {
	_zsh_highlight_call_widget .vi-set-mark -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-substitute () {
	_zsh_highlight_call_widget .vi-substitute -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-swap-case () {
	_zsh_highlight_call_widget .vi-swap-case -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-undo-change () {
	_zsh_highlight_call_widget .vi-undo-change -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-unindent () {
	_zsh_highlight_call_widget .vi-unindent -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-up-case () {
	_zsh_highlight_call_widget .vi-up-case -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-up-line-or-history () {
	_zsh_highlight_call_widget .vi-up-line-or-history -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-yank () {
	_zsh_highlight_call_widget .vi-yank -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-yank-eol () {
	_zsh_highlight_call_widget .vi-yank-eol -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-vi-yank-whole-line () {
	_zsh_highlight_call_widget .vi-yank-whole-line -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-visual-line-mode () {
	_zsh_highlight_call_widget .visual-line-mode -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-visual-mode () {
	_zsh_highlight_call_widget .visual-mode -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-what-cursor-position () {
	_zsh_highlight_call_widget .what-cursor-position -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-where-is () {
	_zsh_highlight_call_widget .where-is -- "$@"
}
_zsh_highlight_widget_orig-s000-r988-yank-pop () {
