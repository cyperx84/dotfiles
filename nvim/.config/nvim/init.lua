...
require('lazy').setup({
  ...
  require 'cyperx.plugins.nvim-intro',
  require 'cyperx.plugins.colourscheme',
  require 'cyperx.plugins.autoformat',
  require 'cyperx.plugins.autopairs',
  require 'cyperx.plugins.harpoon',
  require 'cyperx.plugins.neo-tree',
...
vim.keymap.set('i', '<C-J>', 'copilot#Accept("<CR>")', { expr = true }) -- Accept completion
...
vim.defer_fn(function()
  require('nvim-treesitter.configs').setup {
    ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'javascript', 'vimdoc', 'vim', 'bash', 'markdown', 'markdown_inline', 'html', 'css', 'json', 'yaml', 'astro' },
...
local servers = {
  ...
  -- rust_analyzer = {},
  tsserver = {},
  html = { filetypes = { 'html', 'astro', 'twig', 'hbs' } },
