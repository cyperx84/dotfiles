...
export GREEN=0xff80ff00
export BLUE=0xff002aff
export YELLOW=0xfff1fc79
export ORANGE=0xffff6b00
...
export SHADOW_COLOR=$ORANGE

# Enhanced space colors for better visual hierarchy
export SPACE_ACTIVE_BG=$TRANSPARENT
export SPACE_ACTIVE_BORDER=$GREEN
export SPACE_ACTIVE_TEXT=$GREEN
export SPACE_INACTIVE_BG=$BACKGROUND_1
export SPACE_INACTIVE_BORDER=$BACKGROUND_2
export SPACE_INACTIVE_TEXT=$ICON_COLOR
export SPACE_EMPTY_TEXT=$GREY
export SPACE_WINDOW_INDICATOR=$ORANGE
